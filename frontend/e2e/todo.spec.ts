...
test.describe('TODO App', () => {
  ...
  test('should display gitflow information', async ({ page }) => {
    await expect(page.getByRole('heading', { name: 'Sobre o Gitflow' })).toBeVisible();
    ...
    await expect(page.getByText('Merges')).toBeVisible();
  });
  ...
  test('should toggle todo completion', async ({ page }) => {
    ...
    const todoItem = page.locator('[data-testid^="todo-item-"]').filter({ hasText: 'Tarefa para completar' });
  ...
  test('should delete a todo', async ({ page }) => {
    ...
    const todoItem = page.locator('[data-testid^="todo-item-"]').filter({ hasText: 'Tarefa para deletar' });
